...
export class HistoryPanel_r extends React.Component{
    ...
    dataHandler = async() =>{
        ...
        var queryString = "https://gmcmap.com/app/app_AJAX_getMarkerHistoryData_r.asp?geigerID=" + currentRefreshState + "&currentPage=" + currentPage + "&AmountPerPage=" + ENTRIES_PER_PAGE + "&timeZone=" + currentTimeZone;
        ...
        if(item.id == 0){
            return (
                <View style={styles.historyItemContainer}>
                    ...
                    <Text style={styles.historyHeaderText}>{item.pci}</Text>
                    <Text style={styles.historyHeaderText}>{item.bq}</Text>
                </View>
            )
        }else{
            return (
                <View style={styles.historyItemContainer}>
                    ...
                    <Text style={styles.historyItemText}>{item.pci}</Text>
                    <Text style={styles.historyItemText}>{item.bq}</Text>
                </View>
            )
        }
    }
